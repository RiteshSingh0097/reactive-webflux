...
public class ItemControllerTest {
    ...
    public void getAllItemsApproach3() {
       Flux<Item> itemFlux =  webTestClient.get().uri(ItemConstant.ITEM_END_POINT_V1)
                .exchange()
                .expectStatus().isOk()
                .expectHeader().contentType(MediaType.APPLICATION_JSON_VALUE)
    ...
    public void getOneItem(){
        webTestClient.get().uri(ItemConstant.ITEM_END_POINT_V1.concat("/{id}"), "ABC")
                .exchange()
                .expectStatus().isOk()
                .expectBody()
    ...
    public void getOneItemNotFound(){
        webTestClient.get().uri(ItemConstant.ITEM_END_POINT_V1.concat("/{id}"), "DEF")
                .exchange()
    ...
    public void createItem(){
        ...
        webTestClient.post().uri(ItemConstant.ITEM_END_POINT_V1)
    ...
    public void deleteItem(){
        webTestClient.delete().uri(ItemConstant.ITEM_END_POINT_V1.concat("/{id}"), "ABC")
    ...
    public void updateItem(){
        Item item = new Item(null, "Iphone X", 999.99);
        webTestClient.put().uri(ItemConstant.ITEM_END_POINT_V1.concat("/{id}"), "ABC")
                .contentType(MediaType.APPLICATION_JSON)
                .body(Mono.just(item), Item.class)
                .exchange()
                .expectStatus().isOk()
